        ...
        if (m.mentionedJid && m.mentionedJid.length > 0) {
            ...
            if (isMention) {
                ...
                **/
                ...
                const messages = [
                    { role: "system", content: "kamu adalah Atri-MD, Seorang Asisten pribadi yang di buat oleh Dhieka Ananda Aquila yang siap membantu 24/7!" },
                    { role: "assistant", content: `Saya Atri-MD, asisten pribadi yang siap membantu kamu kapan pun! Apa yang bisa saya bantu hari ini?` },
