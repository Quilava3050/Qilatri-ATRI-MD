...
║  di mana setiap pemain wajib
║  menyambung kata dari huruf
║  terakhir kata sebelumnya.
╚═════`.trim()

const rules = `╔══「 *ATURAN MAIN* 」
╟ Jawaban harus berupa kata dasar,
║  tidak boleh pakai spasi atau
║  imbuhan seperti me-, -kan, dll.
╟ Pemain terakhir yang tersisa
║  akan menang dan mendapat
║  500xp dikali jumlah pemain.
╟ Gunakan .skata start untuk mulai!
╚═════`.trim()
let poin = 500
